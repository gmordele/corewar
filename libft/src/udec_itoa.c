...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/01/30 19:44:37 by gmordele          #+#    #+#             */
/*   Updated: 2017/03/17 14:48:32 by gmordele         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int		get_decimal_len(unsigned n)
{
	int len;
...
static void		fill_number(char *buff, unsigned n, int start, int len)
{
	while (len--)
	{
		buff[start--] = n % 10 + '0';
