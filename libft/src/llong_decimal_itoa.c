...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   llong_decimal_itoa.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: gmordele <gmordele@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/01/26 17:37:11 by gmordele          #+#    #+#             */
/*   Updated: 2017/03/16 17:59:28 by gmordele         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	fill_flags(char *buff, long long n, t_buff_info bi, t_conv_spec cs)
{
	int	pos_sign;
