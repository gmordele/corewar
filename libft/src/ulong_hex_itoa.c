...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/01/29 21:54:51 by gmordele          #+#    #+#             */
/*   Updated: 2017/03/16 18:03:58 by gmordele         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void		fill_number_small(char *buff, unsigned long n,
								int start, int len)
{
...
static void		fill_number_big(char *buff, unsigned long n, int start, int len)
{
	static char	digits[16] = "0123456789ABCDEF";
