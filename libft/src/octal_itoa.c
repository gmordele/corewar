...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/01/27 18:50:48 by gmordele          #+#    #+#             */
/*   Updated: 2017/03/16 18:19:48 by gmordele         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int		get_octal_len(unsigned int n)
{
	int	len;
...
static void		fill_number(char *buff, unsigned int n, int start, int len)
{
	while (len--)
	{
		buff[start--] = n % 8 + '0';
