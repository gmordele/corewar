...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/01/30 19:47:01 by gmordele          #+#    #+#             */
/*   Updated: 2017/03/17 16:40:27 by gmordele         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int		get_decimal_len(unsigned long n)
{
	int len;
...
static void		fill_number(char *buff, unsigned long n, int start, int len)
{
	while (len--)
	{
		buff[start--] = n % 10 + '0';
